...
#
# end Ashley's handy constants & vars for this project
# ----------------------------------------------------
...
# PlantUML
# --------
# The PlantUML plugn-in requires that there is a variable  named
#   plantuml
# _and_ the value is set to the path for the plantuml.jar
...
plantuml = 'java -jar %s' % os.path.join(os.path.dirname(os.path.abspath(__file__)), "plantuml.jar")
...
# - show section author and module author -
...
# - ignored prefixes for  module index -
...
#
# html_title = u'PlantUML v1.2017.16'
...
htmlhelp_basename = PROJECT_TOP_FILENAME
...
latex_documents = [
   (master_doc, PROJECT_TOP_FILENAME + '.tex', PROJECT_NAME,
    ASHLEY, 'manual'),
]
...
man_pages = [
   (master_doc, PROJECT_TOP_FILENAME, PROJECT_NAME, [author], 1)
]
...
texinfo_documents = [
   (master_doc, PROJECT_TOP_FILENAME, PROJECT_NAME, author,
    'PlantUML', PROJECT_DESC, 'Documentation'),
]
